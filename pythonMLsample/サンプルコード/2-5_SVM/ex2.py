...
# 入力データのファイルパス
load_input_data_path = "C:/github/sample/python/scikit/svm/ex2_data/train.csv"

# 学習済みモデルデータの出力先パス
save_trained_data_path = 'C:/github/sample/python/scikit/svm/ex2_data/train.learn'

# テストデータのファイルパス
load_test_data_path = "C:/github/sample/python/scikit/svm/ex2_data/test.csv"

# グラフ出力先パス
save_graph_img_path = 'C:/github/sample/python/scikit/svm/ex2_data/graph3.png'
